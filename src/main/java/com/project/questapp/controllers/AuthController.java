...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(@RequestBody UserRequest registerRequest) {
        AuthResponse authResponse = new AuthResponse();
        if(userService.getOneUserByUserName(registerRequest.getUserName()) != null) { //eğer böyle bi user varsa
            authResponse.setMessage("Username already in use."); //zaten böyle bi user var mesajı döndük
